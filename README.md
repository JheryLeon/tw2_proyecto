...
## Instalación - CakePHP (Puerto 8765)
...
3. **Configurar base de datos**
   ...
   Editar `config/app_local.php` con las credenciales de tu MySQL:
   ```php
   'Datasources' => [
       'default' => [
           'host' => 'TU_IP_MYSQL',    // IP de tu servidor MySQL
...
4. **Importar base de datos**
   ...
   Ejecutar el script `db_ef.sql` en phpMyAdmin o MySQL:
   - Abrir phpMyAdmin
   - Seleccionar tu base de datos
   - Importar el archivo `db_ef.sql` que está en la raíz del proyecto

5. **Permisos de carpetas (Opcional si da errores)**
   ```bash
...
## Instalación - Contenedor Docker/Podman (Puerto 8080)
...
1. **Entrar a la carpeta descargada**
   ```bash
   cd tw2_proyecto
   ```

2. **Configurar base de datos (sino configuraste en cake)**

   Editar `app_ef/config/app_local.php` con las credenciales de tu MySQL:
   ```php
   'Datasources' => [
       'default' => [
           'host' => 'TU_IP_MYSQL',    // IP de tu servidor MySQL
...
3. **Importar base de datos**
   ...
   - Abrir phpMyAdmin
   - Seleccionar tu base de datos
   - Importar el archivo `app_ef/db_ef.sql` que está en la carpeta app_ef
...
- El contenedor ejecuta `composer install` automáticamente al construir
- El contenedor usa PHP 8.4 con Apache
- La base de datos debe estar configurada en `app_ef/config/app_local.php`
